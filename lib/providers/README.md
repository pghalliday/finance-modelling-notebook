...
```
    ...
    [2025-08-06 : Wed : Provided(values=('Value 1',), complete=False)
     ...
     2025-08-08 : Fri : Provided(values=('Value 1',), complete=False)
     ...
     2025-08-14 : Thu : Provided(values=('Value 3',), complete=True)
     2025-08-15 : Fri : Provided(values=(), complete=True)]
...
```
    ...
    [2025-08-06 : Wed : Provided(values=('Always value', 'Value 1'), complete=False)
     ...
     2025-08-08 : Fri : Provided(values=('Always value', 'Value 1'), complete=False)
     ...
     2025-08-14 : Thu : Provided(values=('Always value', 'Sometimes value', 'Value 3'), complete=False)
     2025-08-15 : Fri : Provided(values=('Always value',), complete=False)]
...
```
    ...
    File ~/projects/github/pghalliday/finance-modelling-notebook/lib/utils/format.py:14, in format_values(values)
         13 def format_values(values: Sequence[Tuple[date, str]]) -> str:
    ---> 14     return '[' + '\n '.join([f'{format_day(day)} : {value}' for day, value in values]) + ']'


    File ~/projects/github/pghalliday/finance-modelling-notebook/lib/providers/merge_map_provider.py:25, in MergeMapProvider.get(self, current_date)
